...
export default function Head({ className }){
  return (
    <section className={`relative ${ jetBrainsMono.className } select-none text-custom-iceberg ${ className }`} >
      ...
      <h1 className="transition-all ease-in-out duration-150 font-extrabold lg:text-8xl md:text-7xl sm:text-6xl text-5xl xl:mb-8 lg:mb-4 mb-1">lucas-aquino</h1>
      <div>
        <h2>
      ...
      <div className="absolute -top-5 -end-1 p-0 select-none rounded-full backdrop-blur-md border border-custom-blue-zodiac">
        <img
