...
export default function Article({ className, ...rest}) {
  return (
    <article className={`relative select-none px-8 pb-8 pt-14 bg-article-gradient rounded-3xl backdrop-blur-md border border-custom-blue-zodiac ${ className }`} {...rest}>
